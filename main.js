...
//cover.addEventListener('touchstart', hideCover);
...
function moveUp() { 
	...
	if (hero.movement < 1){
		...
		if (hero.positionNumber < 16 || upperField.className == "wall" || upperField.className == "door" || upperField.className == "tunnelvertical" || upperField.className == "tunnelhorizontal" || upperField.className == "forrest" || upperField.className == "chest" || upperField.className == "darkWall"){
...
function moveDown() { 
	...
	if (hero.movement < 1){
		...
		if (hero.positionNumber > 111 || lowerField.className == "wall" || lowerField.className == "door" || lowerField.className == "tunnelvertical" || lowerField.className == "tunnelhorizontal" || lowerField.className == "forrest" || lowerField.className == "chest" || lowerField.className == "darkWall"){
...
function moveLeft() {
	...
	if (hero.movement < 1){
		...
		if (hero.positionNumber % 16 == 0 || leftField.className == "wall" || leftField.className == "door" || leftField.className == "tunnelhorizontal" || leftField.className == "tunnelvertical" || leftField.className == "forrest" || leftField.className == "chest" || leftField.className == "darkWall"){
...
function moveRight() {
	...
	if (hero.movement < 1){
		...
		if (hero.positionNumber % 16 == 15 || rightField.className == "wall" || rightField.className == "door" || rightField.className == "tunnelhorizontal" || rightField.className == "tunnelvertical" || rightField.className == "forrest" || rightField.className == "chest" || rightField.className == "darkWall"){
...
//monster and dungeon Sounds
	...
	dungeon.audioMadnessRumble = new Audio('madnessRumble.mp3');
	dungeon.audioMadnessKill = new Audio('madnessKill.mp3');
...
function door(){
	...
	if (hero.positionNumber == dungeon.doorPosition && dungeon.heroActions > 0){
		...
		switch(dungeon.mapPointer) {
			...
			case 9:
			mapBuilder10();
			dungeon.mapPointer = 10;
			checkView();
			break;
			
			case 10:
			mapBuilder11();
			dungeon.mapPointer = 11;
			checkView();
			break;
			
			case 11:
			mapBuilder12();
			dungeon.mapPointer = 12;
			let p6 = document.getElementById("view");
			p6.src = "backgroundDark.gif";
			dungeon.view = "backgroundDark.gif";
			break;
		...
		if (hero.positionNumber == dungeon.doorPosition2 && dungeon.heroActions > 0){
			m.textContent = "You entered another room!";
			secretDoor();	
		}	
	}
};
...
function secretDoor(){
	...
	switch(dungeon.mapPointer) {
			case 3:
			mapBuilder99();
			dungeon.mapPointer = 98;
			checkView();
			break;

			case 98:
			mapBuilder98();
			dungeon.mapPointer = 97;
			checkView();
			break;

			case 97:
			mapBuilder97();
			dungeon.mapPointer = 96;
			checkView();
			break;

			case 96:
			mapBuilder96();
			dungeon.mapPointer = 95;
			checkView();
			break;
			...
			case 7:
			mapBuilder89();
			dungeon.mapPointer = 89;
			checkView();
			break;

			case 89:
			mapBuilder88();
			dungeon.mapPointer = 88;
			checkView();
			break;
...
dungeon.map4 = ["wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","wall","wall","wall","light","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
...
dungeon.map7 = [
  "wall","hero","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","door","wall",
"wall","light","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","light","light","wall",
"wall","light","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","light","light","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","wall",
"wall","light","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","light","light","altar",
"wall","light","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","light","light","wall",
"wall","light","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","altar","light","wall",
"wall","door","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall"
]


dungeon.map8 = [
  "wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall",
"wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall",
"wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","wall",
"wall","wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","wall","wall",
  "wall","wall","wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","wall","wall","wall",
  "wall","wall","wall","wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","wall","wall","wall","wall",
  "wall","wall","wall","door","heroDark","dark","dark","dark","dark","dark","dark","door","wall","wall","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall"
]
...
dungeon.map9 = [
  ...
  "darkWall","darkWall","darkWall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","darkWall","darkWall",
  "darkWall","darkWall","wall","wall","wall","gravel","wall","wall","gravel","wall","wall","gravel","wall","wall","wall","darkWall",
  "darkWall","wall","wall","wall","light","light","light","light","light","light","light","light","light","light","door","darkWall",
  "darkWall","wall","hero","light","light","light","light","light","light","light","light","light","light","wall","wall","darkWall",
  "darkWall","wall","wall","wall","wall","gravel","wall","wall","gravel","wall","wall","gravel","wall","wall","wall","darkWall",
  "darkWall","darkWall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","darkWall","darkWall",
"darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall"
]
...
dungeon.map10 = [
  "wall","wall","wall","wall","hero","wall","door","wall","wall","door","wall","wall","wall","wall","wall","wall",
  "wall","light","wall","wall","light","light","light","wall","wall","gravel","wall","wall","light","altar","light","wall",
  "wall","light","light","light","light","light","light","light","wall","wall","wall","light","light","light","light","wall",
  "wall","light","light","wall","light","light","light","light","light","light","light","light","light","light","light","wall",
  "wall","light","light","wall","light","light","light","light","light","light","light","light","light","light","light","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","wall",
  "wall","light","wall","wall","wall","light","light","light","light","light","light","light","wall","door","wall","wall",
  "wall","wall","wall","door","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall"
]

dungeon.map11 = ["wall","wall","hero","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
...
dungeon.map12 = ["darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
...
dungeon.map89 = [
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","chest","chest","chest","wall","light","light","wall","wall",
  "wall","hero","wall","wall","wall","wall","wall","wall","light","light","light","wall","light","light","light","wall",
  "wall","light","light","wall","wall","wall","wall","wall","wall","light","wall","wall","light","light","light","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","wall",
  "door","light","light","light","light","light","light","light","wall","wall","wall","light","light","light","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall"
]
...
dungeon.map88 = [
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","light","light","light","wall","wall","wall","hero","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","light","wall","light","light","wall","light","light","wall",
  "wall","wall","wall","wall","door","light","light","wall","light","wall","wall","light","wall","light","wall","wall",
  "wall","wall","wall","wall","wall","wall","light","wall","light","light","wall","light","wall","irongate","wall","wall",
  "wall","wall","wall","wall","wall","wall","light","wall","wall","irongate","wall","light","light","light","wall","wall",
  "wall","wall","wall","wall","wall","wall","light","light","light","light","wall","wall","wall","wall","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall"
]
...
dungeon.map86 = [
  ...
  "door","light","light","light","light","light","light","light","light","light","light","light","light","light","hero","door",
...
dungeon.map99 =
[
  "wall","hero","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","light","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","gravel","light","wall","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","wall",
  "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","door",
  "wall","wall","light","light","light","light","light","light","light","gravel","light","light","light","light","light","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall"
]
...
[
  ...
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "light","light","light","light","light","light","gravel","light","light","light","light","light","gravel","light","light","wall",
  "hero","light","light","light","light","light","light","light","light","light","light","light","light","light","light","door",
  "light","light","light","light","light","light","light","light","light","gravel","light","light","light","gravel","gravel","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
"darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall"
]
...
[
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","wall","wall","darkWall","darkWall","darkWall","darkWall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","gravel","wall","wall","wall","wall","wall",
  "hero","light","light","light","gravel","gravel","gravel","light","light","light","light","gravel","light","light","gravel","door",
  "light","light","light","light","light","light","light","light","gravel","gravel","light","light","light","gravel","gravel","wall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
"darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall"
]
...
"darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
   "wall","light","light","light","light","light","light","light","light","light","light","light","light","light","light","light",
  "wall","hero","light","light","light","light","light","light","light","light","light","light","light","light","light","light",
"wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall","wall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
]
...
dungeon.map90 = [
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","wall","wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","wall","door","wall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall",
  "darkWall","wall","wall","wall","wall","darkWall","darkWall","wall","light","wall","darkWall","wall","wall","wall","wall","darkWall",
  "darkWall","wall","light","light","wall","wall","wall","wall","light","wall","wall","wall","light","light","wall","darkWall",
  "darkWall","wall","chest","light","light","light","light","light","light","light","light","light","light","chest","wall","darkWall",
  "darkWall","wall","light","light","wall","wall","wall","wall","hero","wall","wall","wall","light","light","wall","darkWall",
  "darkWall","wall","wall","wall","wall","darkWall","darkWall","wall","wall","wall","darkWall","wall","wall","wall","wall","darkWall",
  "darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall","darkWall"
]
...
function mapBuilder7(){
	...
	hero.positionNumber = 1;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];
	dungeon.reserveFieldPosition[0] = 0;
	dungeon.reserveFieldPosition[1] = 1;
	dungeon.reserveFieldPosition[2] = 2;
	...
	dungeon.doorPosition = 30;
	dungeon.doorPosition2 = 97;
};
...
function mapBuilder8(){
	...
	dungeon.doorPosition = 106;
};

function mapBuilder9(){
	if(dungeon.monsterList.length > 0 || dungeon.reserveMonsterList > 0){
		dungeon.monsterComingAfterYouCounter = 4;
		dungeon.reserveMonsterList = dungeon.monsterList.concat(dungeon.reserveMonsterList);
	}
	dungeon.monsterList = [];
	hero.positionNumber = 66;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];
	dungeon.reserveFieldPosition[0] = 50;
	dungeon.reserveFieldPosition[1] = 82;
	dungeon.reserveFieldPosition[2] = 83;

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map9[i];
	}
	dungeon.doorPosition = 61;
};

function mapBuilder10(){
	if(dungeon.monsterList.length > 0 || dungeon.reserveMonsterList > 0){
		dungeon.monsterComingAfterYouCounter = 4;
		dungeon.reserveMonsterList = dungeon.monsterList.concat(dungeon.reserveMonsterList);
	}
	dungeon.monsterList = [];
	hero.positionNumber = 4;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];
	dungeon.reserveFieldPosition[0] = 48;
	dungeon.reserveFieldPosition[1] = 64;
	dungeon.reserveFieldPosition[2] = 80;

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map10[i];
	}
	const goblin4 = new Goblin(999);
	dungeon.monsterList.push(goblin4);
	const goblin5 = new GoblinArcher(999);
	dungeon.monsterList.push(goblin5);
	dungeon.doorPosition = 93;
	dungeon.doorPosition2 = 22;
};


function mapBuilder11(){
	if(dungeon.monsterList.length > 0 || dungeon.reserveMonsterList > 0){
		dungeon.monsterComingAfterYouCounter = 4;
		dungeon.reserveMonsterList = dungeon.monsterList.concat(dungeon.reserveMonsterList);
	}
	...
	dungeon.reserveFieldPosition[3] = 113;
	dungeon.reserveFieldPosition[4] = 114;

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map11[i];
	}
	dungeon.doorPosition = 110;
	const goblin6 = new Goblin(999);
	dungeon.monsterList.push(goblin6);
	const lich1 = new Lich(93);
	dungeon.monsterList.push(lich1);
...
function mapBuilder12(){
	...
	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map12[i];
	}
...
function mapBuilder90(){
	dungeon.monsterComingAfterYouCounter = 0;
	dungeon.reserveMonsterList = [];
	dungeon.monsterList = [];
	hero.positionNumber = 88;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map90[i];
	}
	dungeon.doorPosition = 40;
};
...
function mapBuilder89(){
	if(dungeon.monsterList.length > 0 || dungeon.reserveMonsterList > 0){
		dungeon.monsterComingAfterYouCounter = 4;
		dungeon.reserveMonsterList = dungeon.monsterList.concat(dungeon.reserveMonsterList);
	}
	dungeon.monsterList = [];
	hero.positionNumber = 33;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];
	dungeon.reserveFieldPosition[0] = 17;
	dungeon.reserveFieldPosition[1] = 34;
	dungeon.reserveFieldPosition[2] = 51;

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map89[i];
	}
	dungeon.doorPosition2 = 97;
};


function mapBuilder88(){
	dungeon.monsterComingAfterYouCounter = 0;
	dungeon.reserveMonsterList = [];
	dungeon.monsterList = [];
	hero.positionNumber = 30;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map88[i];
	}
	dungeon.doorPosition2 = 53;
};
...
function mapBuilder87(){
	...
	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map87[i];
	}
	dungeon.doorPosition = 99;
	dungeon.doorPosition2 = 30;
};

function mapBuilder86(){
	hero.positionNumber = 30;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];
	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map86[i];
	}
	dungeon.doorPosition = 37;
};



function mapBuilder99(){
	dungeon.monsterComingAfterYouCounter = 0;
	dungeon.reserveMonsterList = [];
	dungeon.monsterList = [];
	hero.positionNumber = 1;
	...
	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map99[i];
	}
	dungeon.doorPosition2 = 78;
};


function mapBuilder98(){
	hero.positionNumber = 64;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map98[i];
	}
	dungeon.doorPosition2 = 78;
};

function mapBuilder97(){
	hero.positionNumber = 64;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];
	...
	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map97[i];
	}
	dungeon.doorPosition2 = 78;
	dungeon.doorPosition = 58;
};

function mapBuilder96(){
	hero.positionNumber = 65;
	helpMap.heroPosition = helpMap.fields[hero.positionNumber];

	for(i=0;i<128;i++){
		let currentFieldId = helpMap.fields[i];
		let currentField = document.getElementById(currentFieldId);
		currentField.className = dungeon.map96[i];
	}
	const madness1 = new Madness(79);
	dungeon.monsterList.push(madness1);
	if(dungeon.music > 1){
		dungeon.audio1.pause();
		dungeon.audio2.pause();
		dungeon.audio3.pause();
		...
		if(dungeon.monsterList[dungeon.monsterOnTurn-1].type == 1){
			...
			if(dungeon.monsterList[dungeon.monsterOnTurn-1].type == 2){
				...
				if(dungeon.monsterList[dungeon.monsterOnTurn-1].type == 3){
					...
					if(dungeon.monsterList[dungeon.monsterOnTurn-1].type == 4){
						madnessRoutine();
					}
				}
			}
...
function madnessMove() {
	let m = document.getElementById("message");
	m.textContent = "...you can hear something rumbling in the dark...";
	dungeon.audioMadnessRumble.play();
}


function madnessAttack(){
		let m = document.getElementById("message");
		let heroId = helpMap.heroPosition;
		let shitField = document.getElementById(heroId);
		hero.life = 1;
		...
		p2.src = "madness.gif";
		dungeon.viewAltered = true;
		let madnessField1 = document.getElementById(helpMap.fields[48]);
		madnessField1.className = "madness1";
		let madnessField2 = document.getElementById(helpMap.fields[49]);
		madnessField2.className = "madness2";
		let madnessField3 = document.getElementById(helpMap.fields[64]);
		madnessField3.className = "madness3";
		let madnessField4 = document.getElementById(helpMap.fields[65]);
		madnessField4.className = "madness4";
		for(i=50;i<63;i++){
			let currentFieldId = helpMap.fields[i];
			let currentField = document.getElementById(currentFieldId);
			currentField.className = "blood";
		}
		for(i=66;i<79;i++){
			let currentFieldId = helpMap.fields[i];
			let currentField = document.getElementById(currentFieldId);
		...
		let madnessFieldEnd1 = document.getElementById(helpMap.fields[63]);
		madnessFieldEnd1.className = "bloodEnd1";
		let madnessFieldEnd2 = document.getElementById(helpMap.fields[79]);
		madnessFieldEnd2.className = "bloodEnd2";
		dungeon.audioMadnessKill.play();
};
